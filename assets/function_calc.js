...
const TRYSHOPPY_CATEGORY_ADJUSTMENT = {
  // ═══════════════════════════════════════════════════════════
  //  آخر مراجعة تسعير — مبنية على تكلفة فعلية مؤكدة:
  //    شحن دولي 1150 ج/كجم (شامل أثر الوزن الحجمي كمتوسط)
  //    جمارك 10% + توصيل داخلي 80 ج + تشغيل 80 ج
  //    الدولار 50.25 ج
  //  هامش المحفظة المتوقع بعد الخصومات دي: ~20%
  //  ⚠️ لو تكلفة الشحن ارتفعت عن 1150 بشكل ملحوظ، راجع الجدول ده
  //     فورًا — الفئات التقيلة (أطعمة/قطع غيار/ملابس) هامشها ضيق
  //     وحساس جدًا لأي زيادة في سعر الكيلو.
  // ═══════════════════════════════════════════════════════════

  // ── فئات كثيفة (وزنها خفيف وقيمتها عالية) = هامش سمين ──
  "Shampoo or Conditioner": 0.90,       // -10%  (هامش بعده ~44%)
  "Cosmetics": 0.90,                    // -10%  (~29%)
  "Sunglasses": 0.92,                   // -8%   (~26%)
  "Vitamin or Supplements": 0.96,       // -4%   (~37%) طلب قوي فمش محتاج خصم أكبر
  "Accessories": 0.96,                  // -4%   (~28%)
  "Watches": 0.97,                      // -3%   (~22%)
  "Electronics": 0.95,                  // -5%   (~23%)

  // ── فئات تقيلة/ضخمة = هامش أضيق، الخصم هنا بحد أقصى 8% ──
  "Stationary": 0.92,                   // -8%   (~19%)
  "Shoes (Regular)": 0.92,              // -8%   (~19%)
  "Back bag (or Lap bag)": 0.92,        // -8%   (~19%)
  "Small Size Hand bag (women)": 0.92,  // -8%   (~16%)
  "Large Size Hand bag (women)": 0.93,  // -7%   (~16%)
  "Jacket or BALTO": 0.92,              // -8%   (~12%) ⚠️ هامش ضيق
  "Clothes (Regular)": 0.92,            // -8%   (~11%) ⚠️ هامش ضيق
  "Shoes (Boot)": 0.92,                 // -8%   (~12%) ⚠️ هامش ضيق
  "CarParts": 0.95,                     // -5%   (~7%)  ⚠️ هامش ضيق جدًا
  "Food": 0.94                          // -6%   (~6%)  ⚠️ هامش ضيق جدًا
};
