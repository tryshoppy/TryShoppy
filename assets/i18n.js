...
const I18N = {
  ...
  faq_a4:          { en: "Orders from US stores look like <b class=\"mono\">TRY12345678</b>, and Try Shoppy Mart orders look like <b class=\"mono\">MART123456</b>. You receive your number when the order is confirmed, and you can enter it on the <a href=\"track.html\">Track Order</a> page at any time.", ar: "طلبات المتاجر الأمريكية رقمها بالشكل ده <b class=\"mono\">TRY12345678</b>، وطلبات تراي شوبي مارت بالشكل ده <b class=\"mono\">MART123456</b>. الرقم بيوصلك وقت تأكيد الطلب، وتقدر تدخله في صفحة <a href=\"track.html\">تتبع الطلب</a> في أي وقت." },
  ...
  trk_format_note: { en: "Orders from US stores start with TRY, and Try Shoppy Mart orders start with MART.", ar: "طلبات المتاجر الأمريكية بتبدأ بـ TRY، وطلبات تراي شوبي مارت بتبدأ بـ MART." },
